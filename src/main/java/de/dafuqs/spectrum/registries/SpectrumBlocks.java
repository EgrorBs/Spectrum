...
public class SpectrumBlocks {
	...
	public static final Block FLAYED_EARTH = register(blockWithItem("flayed_earth", new VariableHeightBlock(Settings.copy(Blocks.MUD).mapColor(MapColor.STONE_GRAY).sounds(BlockSoundGroup.HONEY).velocityMultiplier(0.25F).jumpVelocityMultiplier(0.9F).strength(5F, 15F), 9), InkColors.GRAY).withBlockModel((ctx, block) -> VariantsBlockStateSupplier.create(block, SpectrumModelHelper.createModelVariant(TexturedModel.CUBE_ALL.upload(block, ctx.modelCollector)), SpectrumModelHelper.createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "_1").upload(block, "_1", ctx.modelCollector)), SpectrumModelHelper.createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "_2").upload(block, "_2", ctx.modelCollector)))));
	public static final Block SLAKE_PAESIAN = register(blockWithItem("slake_paesian", new VariableHeightBlock(Settings.copy(Blocks.MUD).mapColor(MapColor.TERRACOTTA_YELLOW).sounds(BlockSoundGroup.MUDDY_MANGROVE_ROOTS).velocityMultiplier(0.9F).strength(7F, 25F), 15), InkColors.GRAY).withBlockModel((ctx, block) ->
			VariantsBlockStateSupplier.create(block, SpectrumModelHelper.createModelVariant(SpectrumTexturedModels.cubeBottomTop(b -> b, "_side", b -> b, "_top", b -> FLAYED_EARTH, "").upload(block, ctx.modelCollector)), SpectrumModelHelper.createModelVariant(SpectrumTexturedModels.cubeBottomTop(b -> b, "_side_1", b -> b, "_top_1", b -> FLAYED_EARTH, "").upload(block, "_1", ctx.modelCollector)), SpectrumModelHelper.createModelVariant(SpectrumTexturedModels.cubeBottomTop(b -> b, "_side_2", b -> b, "_top_2", b -> FLAYED_EARTH, "").upload(block, "_2", ctx.modelCollector)))));
